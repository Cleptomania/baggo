...
from components import Position, Renderable, Viewshed
...
class GameState:
    ...
    def __init__(self):
        ...
        esper.add_component(self.player, Viewshed([], 8))
...
class Game(baggo.App):
    def __init__(self):
        ...
        visibility_processor = VisibilityProcessor()
        esper.add_processor(visibility_processor)
