...
class Color(RGBA255):
    ...
    * :py:meth:`.from_iterable`
    ...
    will fail with a :py:class:`~AttributeError`.
    ...
    def rgb(self) -> tuple[int, int, int]:
        ...
        .. code-block:: python
            ...
            >>> from baggo.colors import WHITE
            >>> WHITE[:3]
            (255, 255, 255)
    ...
    def normalized(self) -> RGBANormalized:
        ...
        .. code-block:: python
            ...
            >>> baggo.colors.WHITE.normalized
            (1.0, 1.0, 1.0, 1.0)

            >>> baggo.colors.BLACK.normalized
            (0.0, 0.0, 0.0, 1.0)

            >>> baggo.colors.TRANSPARENT_BLACK.normalized
            (0.0, 0.0, 0.0, 0.0)
    ...
    def replace(
        ...
        .. code-block:: python
            ...
            >>> baggo.colors.BLUE.replace(a = 100)
